...
//	@Bean
//	@Order(1)
//	public SecurityFilterChain securityFilterChain_admin(HttpSecurity http) throws Exception{
//		
//		// securityMatcherを使用してログイン後の遷移先を変更
...
//					
//					// 全員に許可するページ
//					.requestMatchers("/", "login", "/admin/login", "/error", "/webjars/**")
//							.permitAll()
//					
//					// 管理者のみに許可するページ
//					.requestMatchers("/admin/**").hasAuthority(Auth.ADMIN.toString())
